...
import { LineaProduccionCreateSchema, LineaProduccionUpdateSchema, LineaProduccionAssignDeviceSchema } from '../utils/schemas.js';
...
router.put('/:id/device', requireRoles([UsuarioRol.ADMINISTRADOR]), validateBody(LineaProduccionAssignDeviceSchema), assignDevice);
